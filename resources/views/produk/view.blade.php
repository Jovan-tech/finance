        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="custom-card-title">Master Data Produk</h5>
                            <div class="card">
                                <!-- Header Section -->
                                <div class="card-header custom-header d-flex justify-content-between align-items-center">
                                    <span>Daftar Produk</span>
                                    <a href="{{ url('/produk/create') }}" class="btn btn-add">
                                        ...
                                        <table class="table table-bordered" id="dataTable" cellspacing="0">
                                            ...
                                            @forelse ($produk as $P)
                                                  <tr>
                                                      ...
                                                      <td>
                                                            @if($P->gambar)
                                                                <img src="data:image/jpeg;base64,{{ base64_encode($P->gambar) }}" alt="Gambar Produk" width="100">
                                                            @else
                                                                Tidak ada gambar
                                                            @endif
                                                        </td>
